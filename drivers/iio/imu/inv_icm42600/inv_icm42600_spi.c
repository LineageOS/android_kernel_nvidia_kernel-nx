...
{
    const struct spi_driver *sdrv; // Moved declaration up
    const struct of_device_id *of_id; // Moved declaration up
    const struct spi_device_id *id; // Moved declaration up
